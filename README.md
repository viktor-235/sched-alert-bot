...
- [x] Уведомлять об отмененных стримах
- [ ] Bug: Если бот в офлайне, а стрим успел начаться и закончиться, то при онлайне бот уведомит об отмене стрима. Можно
  пофиксить защитой об отправки событий с прошедшим date
